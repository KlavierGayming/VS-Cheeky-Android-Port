...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		{
			case Solo:
				inline bindKeys(Control.UP, [J, FlxKey.UP, NUMPADTWO]);
				inline bindKeys(Control.DOWN, [F, FlxKey.DOWN, X]);
				inline bindKeys(Control.LEFT, [D, FlxKey.LEFT, Z]);
				inline bindKeys(Control.RIGHT, [K, FlxKey.RIGHT, NUMPADTHREE]);
